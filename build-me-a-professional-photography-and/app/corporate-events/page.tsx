...
export const metadata: Metadata = {
  title: "Corporate Event Photo & Video Coverage | Brandon Media Group LLC",
  description:
    "Polished corporate event photo and video coverage for conferences, galas, brand activations, and company events across the DMV area."
};
...
export default function CorporateEventsPage() {
  return (
    <ServicePage
      ...
      subheadline="Coverage for conferences, galas, company events, brand activations, networking events, and milestone celebrations across the DMV area."
      ...
      heroAlt="Polished corporate event with speaker and audience"
      positioning="Corporate events need more than someone with a camera. They need clean coverage, professional presence, reliable delivery, and content that can be used across websites, internal communications, social media, and future marketing."
